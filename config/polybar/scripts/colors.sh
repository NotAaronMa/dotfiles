...
# Replacing colors
sed -i -e 's/bg = .*/bg = #00000000/g' $PDIR/colors.ini  #main background
sed -i -e 's/fg = .*/fg = #CFCFCF/g' $PDIR/colors.ini    #foreground
sed -i -e 's/ac = .*/ac = #d26273/g' $PDIR/colors.ini    #red 
sed -i -e 's/bi = .*/bi = #dc085F5F/g' $PDIR/colors.ini  #
sed -i -e 's/be = .*/be = #dc085F5F/g' $PDIR/colors.ini
sed -i -e 's/mb = .*/mb = #3c003c/g' $PDIR/colors.ini    #bar Segment 1
sed -i -e 's/mgf = .*/mgf = #3c003c/g' $PDIR/colors.ini  #bar Segment corners
sed -i -e 's/mf = .*/mf = #00acc1/g' $PDIR/colors.ini    
# Restarting polybar
$LAUNCH1 &
$LAUNCH2 &
